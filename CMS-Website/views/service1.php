            ...
            <div class="margin2x">
              ...
              <div class="m-12 l-6 margin-bottom-60">
                <div class="float-left">
                  <h3 class="text-strong text-size-20 text-line-height-1 margin-bottom-20"><?= $service1->getTitle()?></h3>
                    <?= $service1->getText()?>
                </div>
              </div>
                <div class="s-12 m-6 margin-bottom-30">
                    <img class="full-img" src="<?php echo "../../CMS-Panel/upload/{$service1->getPic()}" ?>" alt=""/>
                </div>
