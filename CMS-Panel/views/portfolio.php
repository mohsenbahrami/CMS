    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <form method="post" action="../controllers/portController.php" enctype="multipart/form-data" >
                    ...
                    <input type="file" name="pic2" id="pic2" style="width:180px; margin-bottom: 20px" >
                <hr>
