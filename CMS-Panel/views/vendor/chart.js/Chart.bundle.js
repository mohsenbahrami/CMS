...
function interpolate(start, view, model, ease) {
	...
	for (i = 0, ilen = keys.length; i < ilen; ++i) {
		...
		// if a value is added to the models after pivot() has been called, the views
...
var exports$4 = core_element.extend({
	...
	update: function(changed) {
		...
		// that does _view = _model if ease === 1. This causes the 2nd tooltip update to set properties in both the views and models at the same time
